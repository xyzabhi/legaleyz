        ...
        <div className="w-full max-w-md space-y-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-500">
              Sign in to your account to continue to Legaleyz and start using our services
            </p>
          </div>
              ...
              <div className="relative mt-1">
                ...
                >
                  {showPassword ? (
                    ...
                    // eye slash
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.956 9.956 0 012.223-3.592M6.223 6.223A9.956 9.956 0 0012 5c4.478 0 8.268 2.943 9.542 7a9.956 9.956 0 01-4.132 5.225M15 12a3 3 0 01-3 3m0-6a3 3 0 013 3m-3-3l-6-6" />
                    </svg>
                  )}
                </button>
              </div>
